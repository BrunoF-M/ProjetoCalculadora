...
namespace ProjetoCalculadora
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                do
                {
                    ...
                    Console.WriteLine("Developet by Bruno FM.");
                    Console.WriteLine("....");
                    Console.WriteLine();
          ...
          static void About()
        {
                    ...
                    string link;
                    link = "https://github.com/BrunoF-M/ProjetoCalculadora";
                    

                    Console.ForegroundColor = ConsoleColor.DarkRed;
                    Console.WriteLine(FiggleFonts.Standard.Render("ETEC Adolpho Berezin"));
                    Console.ResetColor();
                    ...
                    Console.WriteLine("Aluno: Bruno Freitas");
